            ...
            <div class="p-4 bg-white rounded-xl shadow-md">
                <div class="w-full flex flex-col items-start">
                    ...
                    <div><i class="far fa-calendar-alt text-md mb-4 mr-2"></i><small
                            ...
                            : 23 Oktober 2021 23:59:59</small>
                    </div>
                </div>
                <div>
                    <hr class="my-2"/>
                    ...
                    <ol class="list-decimal ml-4">
                        <li>Untuk petunjuk teknis pengerjaan dapat diakses di <a
                                href="https://ise-its.com/semifinal-student" target="_blank" class="text-blue-500">https://ise-its.com/semifinal-student</a>.
                        </li>
                    ...
                    <div class="justify-center md:flex-row flex flex-col justify-content-end">
                        ...
                        @if ($deadline > \Carbon\Carbon::now())
                            ...
                            @livewireUIScripts
                            <button
                                wire:click="$emit('openModal', 'pages.bionix.peserta.student.semifinal.modal',{{ json_encode(["submission" => ($submission?$submission->id:null)]) }})"
                                class="bg-red-400 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mx-2">
                                <i class="fas fa-cloud-upload-alt mr-2"></i>Unggah Jawaban
                            </button>
                            {{--                            <input type="file"--}}
