    ...
    <form class="w-full max-w-full mt-4" wire:submit.prevent="submit" autocomplete="off">
        ...
        <div class="flex flex-wrap flex-column -mx-3 mb-6">
            <div class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="link-youtube">
                    Link Youtube
                </label>
                <input
                    ...
                    id="link-youtube" type="text" required wire:model.defer="youtubeLink">
            </div>
            <div class="w-full px-3 mb-6 md:mb-0 mt-4">
                ...
                <input type="file"
                       ...
                       accept=".pdf"
                       hidden/>
                <label class="font-xs">Apabila anda hanya ingin mengubah link Youtube, maka anda tidak perlu mengunggah file lagi.</label>
        ...
        <div class="flex flex-wrap mb-2 justify-end">
            <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full" type="submit"
                    wire:loading.attr="disabled" wire:target="fileSemifinal">
                Simpan
            </button>
        </div>
    </form>
