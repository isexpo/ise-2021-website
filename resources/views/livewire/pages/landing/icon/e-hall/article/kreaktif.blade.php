@section('title','Kreaktif')
@section('desc','Kreaktif merupakan sebuah perusahaan Software
                            Development yang memberikan solusi lengkap dan terintegrasi dalam pengembangan perangkat
                            lunak untuk perusahaan, usaha kecil, lembaga pendidikan, lembaga pemerintah, dan bahkan
                            organisasi nirlaba.')
<div>
            ...
            <div class="container-fluid position-relative mx-0 px-0">
                <div class="row mx-5" style="height: 100%;">
                    ...
                    <div
                        ...
                        <h2 class="my-4 text-4xl">Kreaktif</h2>
                        <p class="hindreg text-base pb-lg-5 mb-lg-5">Kreaktif merupakan sebuah perusahaan Software
                            Development yang memberikan solusi lengkap dan terintegrasi dalam pengembangan perangkat
                            lunak untuk perusahaan, usaha kecil, lembaga pendidikan, lembaga pemerintah, dan bahkan
                            organisasi nirlaba.
                        </p>
    ...
    <section class="bg-article2 min-h-screen mt-0 text-center" style="color:#380152;">
        <div class="container" style="padding-top: 5rem !important; font-size: 25px;">
            <div class="pb-5">
                <p class="px-lg-5 mx-5"><strong>Kreaktif merupakan</strong> sebuah perusahaan Software Development yang
                    memberikan solusi lengkap dan terintegrasi dalam pengembangan perangkat lunak untuk perusahaan,
                    usaha kecil, lembaga pendidikan, lembaga pemerintah, dan bahkan organisasi nirlaba.

                </p>
                <p class="mt-5 px-lg-5 mx-5"><strong>Kreaktif telah berdiri</strong> sejak tahun 2016 dan berlokasi di
                    Surabaya. Melihat
                    perubahan bisnis yang semakin kompleks, Kreaktif ingin menjawab segala macam kebutuhan dalam
                    mengarungi transformasi digital perusahaan. Berawal dari pengembangan web, saat ini Kreaktif
                    menyediakan layanan hingga pembuatan Machine Learning dan Business Intelligence.
                    <strong>Kini</strong> Kreaktif telah
                    banyak membantu client nya dengan mendigitalkan proses bisnis, branding produk, meningkatkan
                    penjualan, dan menjadikan bisnis client nya lebih profesional di era digital saat ini, didukung oleh
                ...
                <p class="mt-5 px-lg-5 mx-5"><strong>Melalui jasa yang ditawarkannya</strong>, Departemen Sistem
                    Informasi
                    ITS
                    sangat bangga terhadap Kreaktif karena telah menjadi katalis terhadap perkembangan bisnis dan
                    ekonomi di
                    Indonesia.
                </p>
            </div>
            ...
            <div class="mt-5">
                ...
                <p class="mt-5 fw-bold">Website Development
                </p>
                <p class="px-lg-5 mx-5">Merupakan layanan pengembangan solusi situs web yang menarik dan fungsional baik
                    back-end maupun front-end.
                </p>
                <p class="mt-5 fw-bold">Mobile Apps Development
                </p>
                <p class="px-lg-5 mx-5">Merupakan layanan pengembangan aplikasi end-to-end yang unik, dapat digunakan,
                    dan bermakna.
                </p>
                <p class="mt-5 fw-bold">UI/UX Design
                </p>
                <p class="px-lg-5 mx-5">Merupakan layanan pembuatan desain UI/UX yang memukau dan menarik.
                </p>
                <p class="mt-5 fw-bold">Machine Learning
                </p>
                <p class="px-lg-5 mx-5">Merupakan layanan pemberi solusi cerdas untuk membawa bisnis client ke tingkat
                    yang lebih tinggi, mengarah ke yang lebih baik, dan lebih cepat.
                </p>
            </div>
            <div class="mt-5 pt-5">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <img src="{{asset('img/icon/e-hall/article/kreaktif/pic5.png')}}" class="img-fluid"/>
                    </div>
                    <div class="col-md-4">
                        <img src="{{asset('img/icon/e-hall/article/kreaktif/pic6.png')}}" class="img-fluid"/>
                    </div>
                    <div class="col-md-4">
                        <img src="{{asset('img/icon/e-hall/article/kreaktif/pic7.png')}}" class="img-fluid"/>
                    </div>
                    <div class="col-md-4">
                        <img src="{{asset('img/icon/e-hall/article/kreaktif/pic8.png')}}" class="img-fluid"/>
                    </div>
                    <div class="col-md-4">
                        <img src="{{asset('img/icon/e-hall/article/kreaktif/pic9.png')}}" class="img-fluid"/>
                    </div>
                    <div class="col-md-4">
                        <img src="{{asset('img/icon/e-hall/article/kreaktif/pic2.jpeg')}}" class="img-fluid"/>
                    </div>
                </div>
            </div>
        </div>
