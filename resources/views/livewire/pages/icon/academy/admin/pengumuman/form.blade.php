            ...
            <div class="grid grid-cols-1 gap-6 font-bold">
                ...
                <div class="grid grid-cols-2">
                    ...
                    <div>
                        ...
                        <div class="mt-1 font-normal">
                            <input type="checkbox" id="startup" name="announcement_category" class="pengumuman-form input-radio" value="startup">
                            <label for="startup">Startup</label><br>
                            <input type="checkbox" id="data-science" name="announcement_category" class="pengumuman-form input-radio" value="data-science">
