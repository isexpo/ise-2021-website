        ...
        <form class="mb-10 space-y-6" wire:submit.prevent="akunSubmit" method="POST" autocomplete="off">
            ...
            <div class="grid sm:px-24 sm:gap-x-20 sm:gap-y-10 gap-y-6 grid-cols-1 px-5 gap-x-5">
                <div id="informasi-tim"
                    ...
                    <div>
                        <label for="university_name" class="mb-10">Asal Perguruan Tinggi</label><br>
                        <input wire:model.defer="university_name" type="text" id="university_name"
                               name="university_name"
                               class="registration-form input-text" required>
                    </div>
                    <div wire:ignore>
                        <label for="university_city" class="mb-10">Asal Provinsi/Kota/Kabupaten Perguruan Tinggi</label><br>
                        <select wire:model.defer="university_city" class="js-example-basic-single input-text"
                                name="university_city" required>
                    ...
                    <div>
                        <label for="info_source" class="mb-10">Kamu tau informasi tentang BIONIX College Level
                            dari mana?</label><br>
                ...
                <div id="anggota-tim"
                    ...
                    <div>
                        <label for="member_1_major" class="mb-10">Jurusan Anggota 1</label><br>
                        <input wire:model.defer="member_1_major" type="text" id="member_1_major" name="member_1_major"
                               class="registration-form input-text" required>
                    </div>
                    <div>
                        <label for="member_1_year" class="mb-10">Tahun Angkatan Anggota 1</label><br>
                        <input wire:model.defer="member_1_year" type="number" id="member_1_year" name="member_1_year"
                               class="registration-form input-text" required value="{{date('Y')}}" min="2000"
                               max="{{date('Y')}}">
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="member_1_twibbon" class="mb-10">Link Post Twibbon Anggota 1</label><br>
                    ...
                    <div>
                        <label for="member_2_major" class="mb-10">Jurusan Anggota 2</label><br>
                        <input wire:model.defer="member_2_major" type="text" id="member_2_major" name="member_2_major"
                               class="registration-form input-text">
                    </div>
                    <div>
                        <label for="member_2_year" class="mb-10">Tahun Angkatan Anggota 2</label><br>
                        <input wire:model.defer="member_2_year" type="number" id="member_2_year" name="member_2_year"
                               class="registration-form input-text" value="{{date('Y')}}" min="2000"
                               max="{{date('Y')}}">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input wire:model.defer="member_2_whatsapp" type="text" id="member_2_whatsapp"
                               name="member_2_whatsapp" class="registration-form input-text">
                    ...
                    <div>
                        <label for="member_2_twibbon" class="mb-10">Link Post Twibbon Anggota 2</label><br>
                        <input wire:model.defer="member_2_twibbon" type="text" id="member_2_twibbon"
                               name="member_2_twibbon"
                               class="registration-form input-text">
                    </div>
                    <div>
                        <h2 class="text-2xl inline-block border-b-4 border-indigo-500">Anggota 3 (Optional)</h2>
                    </div>
                    <div>
                    ...
                    <div>
                        <label for="member_3_major" class="mb-10">Jurusan Anggota 3</label><br>
                        <input wire:model.defer="member_3_major" type="text" id="member_3_major" name="member_3_major"
                               class="registration-form input-text">
                    </div>
                    <div>
                        <label for="member_3_year" class="mb-10">Tahun Angkatan Anggota 3</label><br>
                        <input wire:model.defer="member_3_year" type="number" id="member_3_year" name="member_3_year"
                               class="registration-form input-text" value="{{date('Y')}}" min="2000"
                               max="{{date('Y')}}">
                    </div>
                    <div>
                        <label for="member_3_email" class="mb-10">Email Anggota 3</label><br>
                        <input wire:model.defer="member_3_email" type="email" id="member_3_email" name="member_3_email"
                               class="registration-form input-text">
                    </div>
                    <div>
                        ...
                        <small class="text-red-400 font-normal" id="phone_3_error" style="display: none">Penulisan nomor
                            handphone
                            tidak sesuai dengan ketentuan.</small><br/>
                        <small class="text-gray-400 font-normal">*Nomor
                            Handphone diawali 08 dan terdiri dari 10-13 karakter.</small>
                    ...
                    <div>
                        <label for="member_3_twibbon" class="mb-10">Link Post Twibbon Anggota 3</label><br>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            @this.set('university_city', e.target.value)
            });
