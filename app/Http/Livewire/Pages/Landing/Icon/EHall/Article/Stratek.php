...
class Stratek extends Component
{
    public $quizzes;
    public $currentQuiz;
    public $answer;
    ...
    {
        $id_list = [55,56]; // isi dengan ID kuis untuk startup
    ...
    {
        return view('livewire.pages.landing.icon.e-hall.article.stratek')->layout('layouts.landing');
    }
}
