...
class Energeek extends Component
{
    public $quizzes;
    public $currentQuiz;
    public $answer;
    ...
    {
        $id_list = [47,48,49,50]; // isi dengan ID kuis untuk startup
    ...
    {
        return view('livewire.pages.landing.icon.e-hall.article.energeek')->layout('layouts.landing');
    }
}
