...
class Drafta extends Component
{
    public $quizzes;
    public $currentQuiz;
    public $answer;
    ...
    {
        $id_list = [57,58,59,60]; // isi dengan ID kuis untuk startup
    ...
    {
        return view('livewire.pages.landing.icon.e-hall.article.drafta')->layout('layouts.landing');
    }
}
