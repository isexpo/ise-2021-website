...
class Alinamed extends Component
{
    public $quizzes;
    public $currentQuiz;
    public $answer;
    ...
    {
        $id_list = [65,66,67,68]; // isi dengan ID kuis untuk startup
    ...
    {
        return view('livewire.pages.landing.icon.e-hall.article.alinamed')->layout('layouts.landing');
    }
}
