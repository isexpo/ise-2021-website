...
class IlmuDewantara extends Component
{
    public $quizzes;
    public $currentQuiz;
    public $answer;
    ...
    {
        $id_list = [61,62,63,64]; // isi dengan ID kuis untuk startup
    ...
    {
        return view('livewire.pages.landing.icon.e-hall.article.ilmu-dewantara')->layout('layouts.landing');
    }
}
